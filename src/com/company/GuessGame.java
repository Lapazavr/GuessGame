...
public class GuessGame {
    ...
    public void startGame(){
        ...
        while (true){
            ...
            // Вызываем метод guess() из каждого объекта Playet.
            p1.guess();
            p2.guess();
            p3.guess();
            ...
            // Проверяем варианты каждого из игроков на соответствие заданному числу.
            // Если игрок угадал, то присваиваем соответствующей переменной значение true (по умолчанию false).
